package me.hejmo.cameratest.artphelper;
...
import me.hejmo.cameratest.BuildConfig;
...
public class ARTPHelper {
    ...
    public boolean isAllPermissionGrant(Activity activity){
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.M){
            return true;
        }
        String[] permissions =(String[])(mPermissions.toArray(new String[mPermissions.size()]));
        return isAllPermissionGranted(activity,permissions);
